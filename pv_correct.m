...
function pv_correct(data_file, gm_file, wm_file, mask_file, kernel_size)

    % file name extension
    file_name_extension = '.nii.gz';
    % Output file names:
    file_name_data_gm = strcat(data_file, '_gm_k', num2str(kernel_size));
